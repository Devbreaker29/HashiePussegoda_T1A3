...
tours = {"Seven Day Surf Sport Tour" => 1485.00, "Eight Days Relaxing Surf " => 1128.00, "Fourteen Days with Tours " => 1647.00 }
...
loop do
    ...
    # gem tty prompt 
    puts "  "
    puts "Would you like a tour? When you are finished type 'done'.".light_red
    input = gets.strip
...
#    Check for valid menu item
    ...
    if (item)
        puts "  "
        puts "How many tours would you like?".light_red
        quantity = gets.to_i
        if (quantity > 0)
